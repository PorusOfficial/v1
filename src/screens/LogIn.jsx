    ...
    <ScrollView contentContainerStyle={{flexGrow : 1, gap:30}} >
      ...
      <View style={{flex: 2, padding: 3, gap: 35 , marginTop: 30}}>
        ...
        <View style={{flexDirection: 'row', justifyContent:'space-evenly'}}>
          ...
          <Text style={[GlobalStyles.InterRegular, {fontWeight: '700', fontSize: 16}]}>OR</Text>
          <View style={styles.line} />
        </View>
        <View style={{gap: 34}}>
          <SecondaryButton name={'Log in with google'} onPress={() => ' '} Icon={GIcon}/>
          <SecondaryButton name={'Log in with facebook'} onPress={() => ' '} Icon={FbIcon} />
        </View>
      </View>
      <Text
        style={[
