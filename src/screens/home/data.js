...
const FeedData = [
  {
    id: 1,
    title: 'Flood hits Bhajnpura stay indoors and avoid travel.',
    userName: 'NDTV',
    location: 'Burari, Delhi',
    imageURI:
      'https://www.northeasttoday.in/assets/resources/2024/08/IMG-20240820-WA0023.jpg',
    upvotes: 120,
    downvotes: 10,
    comments: 35,
    shares: 20,
  ...
  {
    id: 2,
    title: 'A street fight erupted after a small argument.',
    userName: 'Pritam',
    location: 'Kashmere Gate, Delhi',
    imageURI:
      'https://imagesvs.oneindia.com/webp/hi/img/2022/02/baghpatchaat03-1645706132.jpg',
    upvotes: 85,
    downvotes: 5,
    comments: 20,
    shares: 12,
  ...
  {
    id: 3,
    title: 'Power outage expected tonight from 10 PM to 5 AM.',
    userName: 'Sidhu Moosewala',
    location: 'Rohini, Delhi',
    imageURI:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTL2OqzIgt864ZKVutPQp3dekeQTotqk5o3Q&s',
    upvotes: 60,
    downvotes: 2,
    comments: 10,
    shares: 5,
  ...
  {
    id: 4,
    title: 'Alert!! EarthQuakes in delhi',
    userName: 'Katiya',
    location: 'gaya, bihar',
    imageURI:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRiLwBQmblSLcYjgVg6mEG08vqeRQNSMtSdKg&s',
    upvotes: 200,
    downvotes: 15,
    comments: 45,
    shares: 30,
  ...
  {
    id: 5,
    title: 'Severe air pollution alert issued for Delhi. Wear masks!',
    userName: 'Rahul gym',
    location: 'Connaught Place, Delhi',
    imageURI:
      'https://c8.alamy.com/comp/P4X3JE/delhi-air-pollution-people-wearing-masks-P4X3JE.jpg',
    upvotes: 300,
    downvotes: 25,
    comments: 100,
    shares: 50,
