...
const BottomTabNav = () => {
  ...
  return (
   <Tab.Navigator screenOptions={{headerShown: false, tabBarShowLabel: false, tabBarStyle:{backgroundColor: '#F6F6F6'}}}>
     ...
     <Tab.Screen name='Trand' component={PostDetailScreen} options={{tabBarIcon: ({focused, color, size})=>(<TrendIcon width={size*0.9} height={size*0.8} isActive={focused} />)}} />
     ...
     <Tab.Screen name='Notification1' component={Notification1} options={{tabBarIcon : ({focused, color, size})=>(<BellIcon width={size} height={size} isActive={focused} />)}} />
